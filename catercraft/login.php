                    ...
                    <form id="loginForm">
                        ...
                        <div class="position-relative mb-3">
                            <input type="password" id="loginPassword" class="form-control" placeholder="Password" required
                                   data-bs-toggle="tooltip" title="Password must be at least 6 characters long and include an uppercase letter, a lowercase letter, a number, and a special character (e.g., Aa1@bc)..">
